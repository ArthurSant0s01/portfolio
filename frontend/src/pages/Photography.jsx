  ...
  return (
    <Page>
        ...
        <div className="mt-14 pb-24">
          {!hasPhotos ? (
            <EmptyGallery
              ...
              description="A curated collection of portraits, studio and street photography will live here. New frames are on the way."
            />
          ) : (
      ...
      {active && (
        ...
        >
          <button onClick={() => setActive(null)} data-testid="photo-modal-close" className="absolute top-6 right-6 w-11 h-11 rounded-full glass-strong flex items-center justify-center hover:bg-white hover:text-black transition-colors">
            <X size={20} />
          </button>
